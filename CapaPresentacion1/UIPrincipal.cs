...
namespace Inventarios.WinForms
{
    public partial class UIPrincipal : Form
    {
        ...
        UIIngresoTipoProductoTerminado frmIngresoTipoProductoTerminado;
        UIModificaciónTipoProductoTerminado frmModificaciónTipoProductoTerminado;
        UIConsultarTipoProductoTerminado frmConsultarTipoProductoTerminado;
        UIEliminaciónTipoProductoTerminado frmEliminaciónTipoProductoTerminado;
        ...
        private void inToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (frmIngresoTipoProductoTerminado == null || frmIngresoTipoProductoTerminado.IsDisposed)
                frmIngresoTipoProductoTerminado = new UIIngresoTipoProductoTerminado();

            frmIngresoTipoProductoTerminado.Show();
            frmIngresoTipoProductoTerminado.BringToFront();
        }

        private void modificaciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (frmModificaciónTipoProductoTerminado == null || frmModificaciónTipoProductoTerminado.IsDisposed)
                frmModificaciónTipoProductoTerminado = new UIModificaciónTipoProductoTerminado();

            frmModificaciónTipoProductoTerminado.Show();
            frmModificaciónTipoProductoTerminado.BringToFront();
        }

        private void consultaToolStripMenuItem1_Click(object sender, EventArgs e)
        {

            if (frmConsultarTipoProductoTerminado == null || frmConsultarTipoProductoTerminado.IsDisposed)
                frmConsultarTipoProductoTerminado = new UIConsultarTipoProductoTerminado();

            frmConsultarTipoProductoTerminado.Show();
            frmConsultarTipoProductoTerminado.BringToFront();
        }

        private void eliminaciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (frmEliminaciónTipoProductoTerminado == null || frmEliminaciónTipoProductoTerminado.IsDisposed)
                frmEliminaciónTipoProductoTerminado = new UIEliminaciónTipoProductoTerminado();

            frmEliminaciónTipoProductoTerminado.Show();
            frmEliminaciónTipoProductoTerminado.BringToFront();
        }
    }
}
